...
var addClasses = function addClasses(node, classes) {
  return classes && classes.forEach(function (class) {
...
var prepare = function prepare($elements, options) {
  $elements.forEach(function (el, i) {
    ...
    var animatedClassNames = [options.animatedClassName].concat(customClassNames ? customClassNames.split(' ') : []).filter(function (class) {
